...
class LoginPage(ctk.CTk):
    ...
    def initialize_components(self):
        ...
        title_label = ctk.CTkLabel(self, text="Welcome to HealthBot", font=("Arial", 20, "bold"))
        title_label.grid(row=0, column=0, columnspan=2, padx=10, pady=(50, 50), sticky="ew")
        ...
        # Login Button
        login_button = ctk.CTkButton(self, text="Login", command=self.login, font=("Arial", 12, "bold"))
        login_button.grid(row=3, column=0, columnspan=2, padx=10, pady=10, sticky="ew")

        # Check if credentials file exists
        if not os.path.exists("credentials.txt"):
            # Signup Link
            signup_link = ctk.CTkLabel(self, text="Don't have an account? Sign Up", cursor="hand2", font=("Arial", 10))
            signup_link.grid(row=4, column=0, columnspan=2, padx=10, pady=(0, 10), sticky="ew")
            signup_link.bind("<Button-1>", self.signup)
        else:
            # Forgot Password Link
            forgot_password_link = ctk.CTkLabel(self, text="Forgot Password?", cursor="hand2", font=("Arial", 10))
...
class SignupPage(ctk.CTkToplevel):
    ...
    def initialize_components(self):
        # Create a label for the title
        title_label = ctk.CTkLabel(self, text="Sign Up", font=("Arial", 20, "bold"))
...
, 20), ipadx=20, ipady=5)
        ...
        # Signup Button
        signup_button = ctk.CTkButton(self, text="Sign Up", command=self.signup, font=("Arial", 12, "bold"))
...
class ForgotPasswordPage(ctk.CTkToplevel):
    ...
    def initialize_components(self):
        # Create a label for the title
        title_label = ctk.CTkLabel(self, text="Forgot Password?", font=("Arial", 20, "bold"))
        title_label.pack(pady=(20, 10))

        # Username Label and Entry
        username_label = ctk.CTkLabel(self, text="Enter your Username:", font=("Arial", 12))
        username_label.pack()
        ...
        reset_button = ctk.CTkButton(self, text="Reset Password", command=self.reset_password, font=("Arial", 12, "bold"))
