...
class ChatApplication(tk.Tk):
    ...
    def initialize_components(self):
        ...
        # Menu Bar
        self.menu_bar = tk.Menu(self, bg="#2C3E50", fg="white", activebackground="#34495E", activeforeground="white", font=("Helvetica", 12, "bold"))
        self.config(menu=self.menu_bar)
        
        # Home Menu Button
        home_menu = tk.Menu(self.menu_bar, tearoff=0, bg="#2C3E50", fg="white", activebackground="#34495E", activeforeground="white", font=("Helvetica", 12))
        home_menu.add_command(label="Home", command=self.show_home)
        self.menu_bar.add_cascade(label="Home", menu=home_menu)
        
        # History Menu Button
        history_menu = tk.Menu(self.menu_bar, tearoff=0, bg="#2C3E50", fg="white", activebackground="#34495E", activeforeground="white", font=("Helvetica", 12))
        ...
        recommendations_menu = tk.Menu(self.menu_bar, tearoff=0, bg="#2C3E50", fg="white", activebackground="#34495E", activeforeground="white", font=("Helvetica", 12))
        ...
        # Voice Menu Button
        voice_menu = tk.Menu(self.menu_bar, tearoff=0, bg="#2C3E50", fg="white", activebackground="#34495E", activeforeground="white", font=("Helvetica", 12))
        ...
        # Input Label
        self.input_label = tk.Label(input_frame, text="Input:", font=("Helvetica", 12), bg="#F0F0F0", fg="black")
